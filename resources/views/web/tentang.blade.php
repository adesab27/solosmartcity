...
<head>
    ...
    <title>Profil | Solo Smartcity </title>
...
<body>
    ...
    <div class="row align-items-center choose-c">
        ...
        <div id="produkhukum-table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                <div class="top">
                    <div id="produkhukum-table_filter" class="dataTables_filter"><label><input type="search"
                                class="form-control form-control-sm" placeholder="Search"
                                aria-controls="produkhukum-table"></label>
                    </div>
                </div>
            <div class="data-table">
                <table id="produkhukum-table" class="table table-striped table-hover dataTable no-footer"
                    style="width: 100%;" role="grid" aria-describedby="produkhukum-table_info">
                    <tbody>
                        <tr role="row2" class="odd">
                            <td style="vertical-align: middle; " data-label="Jenis Dokumen" class="sorting_1"><img
                                    class="imgprodukhukum"
                                    src="https://smartcity.tangerangkota.go.id/assets/gambar/pdf.png"></td>
                            <td style="vertical-align: middle; " data-label="Produk Hukum"><a
                                    href="#">
                ...
                <div class="bottom">
                    <div class="dataTables_length" id="produkhukum-table_length"><label>Show <select
                                name="produkhukum-table_length" aria-controls="produkhukum-table"
