...
-->
  ...
  <body>
    ...
    <div class="section properties">
      <div class="container">
        <ul class="properties-filter smart">
          <li>
            <a href="dimensi.html">Smart Governance</a>
          </li>
          <li>
            <a href="dimensi.html">Smart Branding</a>
          </li>
          <li>
            <a href="dimensi.html">Smart Economy</a>
          </li>
          <li>
            <a href="dimensi.html">Smart Living</a>
          </li>
          <li>
            <a href="dimensi.html">Smart Environment</a>
          </li>
          <li>
            <a href="dimensi.html">Smart Society</a>
          </li>
        </ul>
    ...
    <script src="{{asset("web/assets/js/dimensi.js")}}"></script>
