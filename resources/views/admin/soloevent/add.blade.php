                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="{{ route('staff.addViewSoloEvent') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="start_periode" type="date" class="form-control" id="exampleInputPassword1" placeholder="Start Periode">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Masukkan End Periode</label>
                                            <input name="end_periode" type="date" class="form-control" id="exampleInputPassword1" placeholder="End Periode">
                                        </div>
                                        <div class="form-group">
