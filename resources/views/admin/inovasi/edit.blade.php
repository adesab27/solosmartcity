                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="{{route('staff.updateInovasi')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <input name="id" type="text" class="form-control" id="exampleJudulBerita" value="{{$datainovasi->id_inovasi}}">
                                        <div class="form-group">
                                            <label for="exampleJudulBerita">Judul Inovasi</label>
                                            <input name="inovasi_name" type="text" class="form-control" id="exampleJudulBerita" placeholder="Masukkan Judul Inovasi" value="{{$datainovasi->inovasi_name}}">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="customFile">{{$datainovasi->image_url}}</label>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
