                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="{{route('staff.addViewInovasi')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleJudulBerita">Judul Inovasi</label>
                                            <input name="inovasi_name" type="text" class="form-control" id="exampleJudulBerita" placeholder="Masukkan Judul Inovasi">
                                        </div>
                                        <div class="form-group">
